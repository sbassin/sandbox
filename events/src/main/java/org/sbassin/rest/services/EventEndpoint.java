...
import org.sbassin.rest.converters.EventConverter;
...
public class EventEndpoint {
    ...
    public Response listAll() {
        ...
        final List<EventTO> translatedResults = Lists.transform(results, new EventConverter());

        return Response.ok(new GenericEntity<List<EventTO>>(translatedResults) {
        }).build();
    }
}